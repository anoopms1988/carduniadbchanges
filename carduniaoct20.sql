...
insert  into `cars`(`id`,`company_id`,`name`,`is_active`) values (1,1,'Q7','1'),(2,2,'5 series','1'),(3,1,'A6','0'),(4,1,'A6','1'),(5,1,'q5','1'),(6,2,'q5','0');
...
insert  into `cartype`(`id`,`type`) values (1,'new'),(2,'used');
...
insert  into `cities`(`id`,`name`) values (1,'Trivandrum'),(2,'Cochin'),(3,'Banglore'),(4,'Delhi');
...
insert  into `companies`(`id`,`name`,`logo`) values (1,'Audi','audi.jpg'),(2,'BMW','bmw.jpg'),(3,'Mercedes','benz.jpg');
...
CREATE TABLE `customer_enquiry` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `enquiry_type_id` int(20) DEFAULT NULL,
...
/*Data for the table `customer_enquiry` */

insert  into `customer_enquiry`(`id`,`enquiry_type_id`,`customer_id`,`enquiry`,`is_active`) values (1,1,1,'dasdasd','1');
...
insert  into `dealers`(`id`,`company_id`,`city_id`,`name`,`address`,`phonenumber`,`mobilenumber`,`is_active`) values (1,2,2,'asdasdkkkkkkkkkk','sadasd','123213','12321321','0');
...
/*Data for the table `editorial_reviews` */

insert  into `editorial_reviews`(`id`,`variant_id`,`review`,`is_active`) values (1,1,'Audi at its best asdasd','1');
...
insert  into `enquiry_type`(`id`,`type`) values (1,'insurance'),(2,'loan');
...
/*Table structure for table `insurance_enquiry` */

DROP TABLE IF EXISTS `insurance_enquiry`;

CREATE TABLE `insurance_enquiry` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `cartype_id` int(20) DEFAULT NULL,
  `variant_id` int(20) DEFAULT NULL,
  `name` varchar(100) DEFAULT NULL,
  `city_id` int(20) DEFAULT NULL,
  `mobilenumber` varchar(100) DEFAULT NULL,
  `email` varchar(100) DEFAULT NULL,
  `purchase_month` int(20) DEFAULT NULL,
  `purchase_year` int(20) DEFAULT NULL,
  `registrationnumber` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `insurance_enquiry` */

insert  into `insurance_enquiry`(`id`,`cartype_id`,`variant_id`,`name`,`city_id`,`mobilenumber`,`email`,`purchase_month`,`purchase_year`,`registrationnumber`) values (1,1,1,'Tim cook',1,'8089375330','1988anoopms@gmail.com',1,2014,'234324234');
...
/*Table structure for table `loan_enquiry` */

DROP TABLE IF EXISTS `loan_enquiry`;
...
CREATE TABLE `loan_enquiry` (
  ...
  `living_residence` varchar(100) DEFAULT NULL,
  `exchange_car` enum('yes','no') DEFAULT 'no',
  `first_name` varchar(100) DEFAULT NULL,
  `last_name` varchar(100) DEFAULT NULL,
  `email` varchar(100) DEFAULT NULL,
  ...
  `wishlist` enum('yes','no') DEFAULT NULL,
  `wishtime` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `loan_enquiry` */

insert  into `loan_enquiry`(`id`,`cartype_id`,`variant_id`,`age`,`occupation`,`annual_income`,`living_residence`,`exchange_car`,`first_name`,`last_name`,`email`,`mobile`,`city_id`,`pincode`,`wishlist`,`wishtime`) values (1,1,1,20,'eeee',NULL,NULL,'no','dasda','asdasdsa','anoopms@toobler.com','3123123',1,NULL,NULL,NULL);
...
DROP TABLE IF EXISTS `static_details`;
...
/*Data for the table `static_details` */

insert  into `static_details`(`id`,`type`,`text`) values (1,'privacy','Privacy text'),(2,'visitoraggrement','Visitor details');
...
insert  into `steering`(`id`,`variant_id`,`turning_radius`,`steering_type`) values (1,1,4.5,'Power steering'),(2,2,4.5,'power steering');
...
insert  into `users`(`id`,`email`,`password`,`remember_token`) values (1,'1988anoopms@gmail.com','$2a$10$IxbZk6G46Dcynv31M2vs4u0M1B2PfhHRorPQej81VnJn4Vr1was2a','9Qajp41zRN1i4ks69m059dJOxibpAEPQCB5RN1GOjVGRJYeK3ILmTgvgqdrZ');
...
insert  into `variants`(`id`,`car_id`,`name`,`type`,`is_active`) values (1,1,'Q7 x','petrol','0'),(2,2,'5 series x','diesel','1'),(5,1,'Q723432','diesel','0'),(6,1,'Q7asdas','petrol','0'),(7,1,'Q7x','petrol','0');
