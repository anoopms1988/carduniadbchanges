...
insert  into `cars`(`id`,`company_id`,`name`,`is_active`) values (1,1,'Q7','0'),(2,2,'5 series','1'),(3,1,'A6','0'),(4,1,'A6','1'),(5,1,'q5','1'),(6,2,'q5','0');
...
insert  into `editorial_reviews`(`id`,`variant_id`,`review`,`is_active`) values (1,1,'Audi is superb','1');
...
insert  into `users`(`id`,`email`,`password`,`remember_token`) values (1,'1988anoopms@gmail.com','$2a$10$IxbZk6G46Dcynv31M2vs4u0M1B2PfhHRorPQej81VnJn4Vr1was2a','bnRnhdRzxAzUv1z1BFkkDGiA9AhkmAmAtwsmsnbH3jk5KkZeOYhxxsHgY9HO');
